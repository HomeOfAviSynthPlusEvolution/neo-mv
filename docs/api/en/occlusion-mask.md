...
Build an occlusion mask from differences between neighboring block vectors.
...
See [OcclusionMask: computation](../../knowledge/en/occlusion-mask.md) for formulas, rounding and numerical examples.
